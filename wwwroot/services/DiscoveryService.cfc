<cfcomponent output="false" accessors="true">
	...
	<cffunction name="buildQueryPlans" access="private" returntype="array" output="false">
		<cfreturn [
			...
			{ signal_type: "stack_detection", source_name: "bing_rss", query_text: "builtwith coldfusion companies USA" },
			{ signal_type: "stack_detection", source_name: "bing_rss", query_text: "builtwith coldfusion companies Europe" },
			{ signal_type: "stack_detection", source_name: "bing_rss", query_text: "coldfusion companies India" },
			{ signal_type: "stack_detection", source_name: "bing_rss", query_text: "companies using coldfusion worldwide" },
			{ signal_type: "stack_detection", source_name: "bing_rss", query_text: "ZOLL emsCharts coldfusion CFML" },
			{ signal_type: "stack_detection", source_name: "bing_rss", query_text: "site:emscharts.com coldfusion" },
			{ signal_type: "stack_detection", source_name: "bing_rss", query_text: "healthcare software coldfusion company" },
			{ signal_type: "stack_detection", source_name: "bing_rss", query_text: "government website coldfusion .cfm" },
			...
			{ signal_type: "stack_detection", source_name: "bing_rss", query_text: "webtechsurvey coldfusion websites" },
			...
			{ signal_type: "job_discovery", source_name: "bing_rss", query_text: "coldfusion developer remote USD site:remoteok.com" },
			{ signal_type: "job_discovery", source_name: "bing_rss", query_text: "cfml developer site:weworkremotely.com" },
			{ signal_type: "job_discovery", source_name: "bing_rss", query_text: "coldfusion developer site:remote.co" },
			{ signal_type: "job_discovery", source_name: "bing_rss", query_text: "coldfusion developer site:jobspresso.co" },
			{ signal_type: "job_discovery", source_name: "bing_rss", query_text: "coldfusion developer site:workingnomads.com" },
			{ signal_type: "job_discovery", source_name: "bing_rss", query_text: "coldfusion developer site:justremote.co" },
			{ signal_type: "job_discovery", source_name: "bing_rss", query_text: "coldfusion developer site:flexjobs.com" },
			{ signal_type: "job_discovery", source_name: "bing_rss", query_text: "coldfusion developer site:wellfound.com angel.co" },
			{ signal_type: "job_discovery", source_name: "bing_rss", query_text: "coldfusion developer site:upwork.com" },
			{ signal_type: "job_discovery", source_name: "bing_rss", query_text: "coldfusion developer site:simplyhired.com" },
			{ signal_type: "job_discovery", source_name: "bing_rss", query_text: "coldfusion developer site:toptal.com" },
			{ signal_type: "job_discovery", source_name: "bing_rss", query_text: "coldfusion developer site:nodesk.co" },
			{ signal_type: "job_discovery", source_name: "bing_rss", query_text: "coldfusion developer site:remotehabits.com" },
			{ signal_type: "job_discovery", source_name: "bing_rss", query_text: "coldfusion developer site:remotecrew.io" },
			{ signal_type: "job_discovery", source_name: "bing_rss", query_text: "coldfusion developer site:pangian.com" },
